...
RUN npm install -g eslint nodemon node-inspector jade webpack grunt gulp bower browser-sync autoprefixer-cli foundation-cli ember-cli express-generator http-server harp brunch
