...
RUN npm install -g eslint nodemon node-inspector jade webpack grunt gulp bower browser-sync foundation-cli ember-cli express-generator http-server harp brunch
